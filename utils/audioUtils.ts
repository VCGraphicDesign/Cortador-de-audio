...
export const audioBufferToMp3 = (
  ...
  // Initialize Encoder
  // Note: lamejs expects sample rate (e.g. 44100, 48000) and number of channels.
  // Warning: lamejs might fail if sample rate is unusual (e.g. 96000). 
  // Standard rates are best (44100, 48000).
